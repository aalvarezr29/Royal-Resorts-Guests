...
class vcServices: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if appDelegate.ynIPad {
            ...
            case "iPad 2":
                self.imgvwHouse.frame = CGRect(x: 0.0, y: 0.01*self.height, width: 0.2*self.width, height: 0.1*self.height)
                self.imgvwMant.frame = CGRect(x: 0.3*self.width, y: 0.01*self.height, width: 0.2*self.width, height: 0.1*self.height)
                self.imgvwFdesk.frame = CGRect(x: 0.6*self.width, y: 0.01*self.height, width: 0.2*self.width, height: 0.1*self.height)
                self.imgvwSep.frame = CGRect(x: -0.05*self.width, y: 0.14*self.height, width: 0.95*self.width, height: 0.05*self.height)
                self.imgvwTransfer.frame = CGRect(x: 0.0, y: 0.18*self.height, width: 0.3*self.width, height: 0.13*self.height)
                self.imgvwOnLine.frame = CGRect(x: 0.5*self.width, y: 0.18*self.height, width: 0.3*self.width, height: 0.13*self.height)
                self.imgvwRent.frame = CGRect(x: 0.0, y: 0.37*self.height, width: 0.3*self.width, height: 0.13*self.height)
                self.imgvwGift.frame = CGRect(x: 0.5*self.width, y: 0.37*self.height, width: 0.3*self.width, height: 0.13*self.height)
                self.imgvwMarket.frame = CGRect(x: 0.25*self.width, y: 0.56*self.height, width: 0.4*self.width, height: 0.13*self.height)
            ...
            case "iPad Retina":
                ...
                AccView.frame = CGRect(x: 0.05*width, y: 0.09*height, width: 0.9*width, height: 0.9*height);
            default:
                self.imgvwHouse.frame = CGRect(x: 0.0, y: 0.01*self.height, width: 0.18*self.width, height: 0.1*self.height)
                self.imgvwMant.frame = CGRect(x: 0.3*self.width, y: 0.01*self.height, width: 0.18*self.width, height: 0.1*self.height)
                self.imgvwFdesk.frame = CGRect(x: 0.6*self.width, y: 0.01*self.height, width: 0.18*self.width, height: 0.1*self.height)
                self.imgvwSep.frame = CGRect(x: -0.05*self.width, y: 0.14*self.height, width: 0.95*self.width, height: 0.05*self.height)
                self.imgvwTransfer.frame = CGRect(x: 0.03*self.width, y: 0.18*self.height, width: 0.25*self.width, height: 0.13*self.height)
                self.imgvwOnLine.frame = CGRect(x: 0.52*self.width, y: 0.18*self.height, width: 0.25*self.width, height: 0.13*self.height)
                self.imgvwRent.frame = CGRect(x: 0.03*self.width, y: 0.37*self.height, width: 0.25*self.width, height: 0.13*self.height)
                self.imgvwGift.frame = CGRect(x: 0.52*self.width, y: 0.37*self.height, width: 0.25*self.width, height: 0.13*self.height)
            ...
            case "iPhone 5":
                ...
                self.imgvwGift.frame = CGRect(x: 0.5*self.width, y: 0.37*self.height, width: 0.3*self.width, height: 0.13*self.height)
                self.imgvwMarket.frame = CGRect(x: 0.25*self.width, y: 0.56*self.height, width: 0.4*self.width, height: 0.13*self.height)
                AccView.frame = CGRect(x: 0.05*width, y: 0.08*height, width: 0.9*width, height: 0.9*height);
            case "iPhone 5c":
                self.imgvwHouse.frame = CGRect(x: 0.0, y: 0.01*self.height, width: 0.2*self.width, height: 0.1*self.height)
                self.imgvwMant.frame = CGRect(x: 0.3*self.width, y: 0.01*self.height, width: 0.2*self.width, height: 0.1*self.height)
                self.imgvwFdesk.frame = CGRect(x: 0.6*self.width, y: 0.01*self.height, width: 0.2*self.width, height: 0.1*self.height)
        ...
        if appDelegate.strBundleIdentifier == "com.royalresorts.guestservices"{
            ...
            lblHouse = UILabel(frame: CGRect(x: 0.0, y: 0.12*height, width: 0.22*width, height: 0.03*height));
            ...
            lblHouse.font = UIFont(name: "Verdana", size: appDelegate.gblFont6 + appDelegate.gblDeviceFont2)
            ...
            lblMant = UILabel(frame: CGRect(x: 0.3*self.width, y: 0.12*height, width: 0.22*width, height: 0.03*height));
            ...
            lblMant.font = UIFont(name: "Verdana", size: appDelegate.gblFont6 + appDelegate.gblDeviceFont2)
            ...
            lblFdesk = UILabel(frame: CGRect(x: 0.6*self.width, y: 0.12*height, width: 0.22*width, height: 0.03*height));
            ...
            lblFdesk.font = UIFont(name: "Verdana", size: appDelegate.gblFont6 + appDelegate.gblDeviceFont2)
            ...
            lblTransfer = UILabel(frame: CGRect(x: 0.01*self.width, y: 0.3*height, width: 0.3*width, height: 0.07*height));
            ...
            lblTransfer.font = UIFont(name: "Verdana", size: appDelegate.gblFont8 + appDelegate.gblDeviceFont3)
            ...
            lblOnLine = UILabel(frame: CGRect(x: 0.51*self.width, y: 0.33*height, width: 0.3*width, height: 0.03*height));
            ...
            lblOnLine.font = UIFont(name: "Verdana", size: appDelegate.gblFont8 + appDelegate.gblDeviceFont3)
            ...
            lblRent = UILabel(frame: CGRect(x: 0.0, y: 0.52*height, width: 0.3*width, height: 0.03*height));
            ...
            lblRent.font = UIFont(name: "Verdana", size: appDelegate.gblFont8 + appDelegate.gblDeviceFont3)
            ...
            lblGift = UILabel(frame: CGRect(x: 0.51*self.width, y: 0.52*height, width: 0.3*width, height: 0.03*height));
            ...
            lblGift.font = UIFont(name: "Verdana", size: appDelegate.gblFont8 + appDelegate.gblDeviceFont3)
            ...
            lblMarket.font = UIFont(name: "Verdana", size: appDelegate.gblFont8 + appDelegate.gblDeviceFont3)
                            ...
                            for rTypeServ in tableTypeServ.rows{
                                ...
                                if (rTypeServ as AnyObject).getColumnByName("Code").content as! String == "Transfer_" + self.appDelegate.strLenguaje{
                                    if let url = URL.init(string: (rTypeServ as AnyObject).getColumnByName("img").content as! String) {
                                        ...
                                        self.imgvwTransfer.translatesAutoresizingMaskIntoConstraints = true
