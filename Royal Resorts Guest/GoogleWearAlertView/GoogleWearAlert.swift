...
class GoogleWearAlert: NSObject {
    ...
    class func showAlert(title:String, type:GoogleWearAlertType, iAction: Int, form:String) {
        showAlert(title:title, image: nil, type: type, inViewController: GoogleWearAlert.sharedInstance.useDefaultController(), iAction: iAction, form:form)
    }
    
    class func showAlert(title:String, type:GoogleWearAlertType, duration:Double, iAction: Int, form:String) {
        showAlert(title:title, image: nil, type: type, duration: duration, inViewController: GoogleWearAlert.sharedInstance.useDefaultController(), iAction: iAction, form:form)
    }
    
    class func showAlert(title:String, image:UIImage?, type:GoogleWearAlertType, duration:Double = 2.5, inViewController:UIViewController, iAction: Int, form:String) {
        showAlert(title: title, image: image, type: type, duration: duration, inViewController: inViewController, atPostion: .center, canBeDismissedByUser: true, iAction:iAction, form:form)
    }
    
    class func showAlert(title:String, image:UIImage?, type:GoogleWearAlertType, duration:Double, inViewController:UIViewController, atPostion:GoogleWearAlertPosition, canBeDismissedByUser:Bool, iAction: Int, form:String) {
        let alertView = GoogleWearAlertView(title: title, image: image, type: type, duration: duration, viewController: inViewController, position: atPostion, canbeDismissedByUser: canBeDismissedByUser, iAction: iAction, form:form)
