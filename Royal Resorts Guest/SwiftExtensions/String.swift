...
/*extension String {
    ...
    public func subStringWithRange(aRange: Range<Int>) -> String {
        ...
        return subStringWithRange(aRange: converRangeIntToRangeStringIndex(self, range: aRange))
    }
    ...
    public func stringByReplacingOccurrencesOfString(target: String, withString: String, options: NSString.CompareOptions, aRange: Range<Int>!) -> String {
        
        let range = aRange == nil ? nil : converRangeIntToRangeStringIndex(self, range: aRange) as Range<String.Index>!
        
        return stringByReplacingOccurrencesOfString(target: target, withString: withString, options: options, aRange: range)
    }    
}*/
