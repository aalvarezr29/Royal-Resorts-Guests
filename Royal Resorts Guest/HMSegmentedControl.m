...
@synthesize fontDevice=_fontDevice;
...
- (id)initWithSectionTitles:(NSArray *)sectiontitles strBundleIdentifier:(NSString *)strBundleIdentifier  {
    self = [self initWithFrame:CGRectZero];
    
    if (self) {
        self.strBundleIdentifier = strBundleIdentifier;
        [self commonInit];
        self.sectionTitles = sectiontitles;
        self.type = HMSegmentedControlTypeText;
        NSLog(strBundleIdentifier);
    }
...
- (void)commonInit {
    ...
    if (self.strBundleIdentifier.description != nil) {

        if ([self.strBundleIdentifier.description  isEqual: @"com.royalresorts.guestservices"]){
            _backgroundColor = [UIColor whiteColor];
        }else if ([self.strBundleIdentifier.description  isEqual: @"com.royalresorts.guestservicesgrm"]){
    ...
    if (self.strBundleIdentifier.description != nil) {
         ...
         if ([self.strBundleIdentifier  isEqual: @"com.royalresorts.guestservices"]){
...
- (NSDictionary *)resultingTitleTextAttributes {
    ...
    NSDictionary *defaults = @{
                               NSFontAttributeName : [UIFont fontWithName:@"STHeitiSC-Light" size:_fontDevice],
    ...
    if (self.strBundleIdentifier.description != nil) {
        ...
        if ([self.strBundleIdentifier  isEqual: @"com.royalresorts.guestservices"]){
            ...
            defaults = @{
                         ...
                         NSForegroundColorAttributeName : [UIColor colorWithRed:0.73 green:0.53 blue:0.28 alpha:1.0],
                         };
        }else if ([self.strBundleIdentifier  isEqual: @"com.royalresortscaribbean.guestservices"]){
            defaults = @{
                         NSFontAttributeName : [UIFont fontWithName:@"Futura-CondensedExtraBold" size:_fontDevice],
